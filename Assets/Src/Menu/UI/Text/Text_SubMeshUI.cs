...
namespace TMPro
{
    ...
    public class Text_SubMeshUI : MaskableGraphic
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static Text_SubMeshUI AddSubTextObject(TextMeshProUGUI textComponent, MaterialReference materialReference)
        {
            ...
            Text_SubMeshUI subMesh = go.AddComponent<Text_SubMeshUI>();
