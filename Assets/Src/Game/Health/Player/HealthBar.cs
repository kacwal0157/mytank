...
public class HealthBar : MonoBehaviour {
	...
	public float yOffset = 1f;							//Horizontal position offset;
	...
	public bool DrawOFFDistance = true;					//Disable health bar if it out of drawDistance;
	public float drawDistance = 50;
    ...
    public AlphaSettings alphaSettings = new AlphaSettings();
	...
	void Awake()
	{
		...
		{
			healthLink = new RemoteIntHealth();
			Debug.LogWarning("Will be set later");
		}
	...
	void Start () {
		...
		HealthbarPrefab.localScale = new Vector3(3f, 3f, 3f);
		...
		healthInfo.enableAutoSizing = true;
		healthInfo.rectTransform.anchoredPosition = Vector2.zero;
		healthInfoPosition = healthInfo.rectTransform.anchoredPosition;
		healthInfo.fontSizeMin = 1;
		healthInfo.fontSizeMax = 500;
		
		healthbarSize = HealthbarPrefab.sizeDelta * 2;
